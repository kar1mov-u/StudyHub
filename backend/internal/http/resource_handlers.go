...
func (s *HTTPServer) test(w http.ResponseWriter, r *http.Request) {
	...
	defer file.Close()
	err = s.resourceSrv.UploadResource(r.Context(), file, resources.Resource{WeekID: weekID, UserID: userID, ResourceType: resources.ResourceFile, Name: handler.Filename})
	if err != nil {
